...
let img1;
let img2;
// let title = 'translation, audio and image credit: https://tinyurl.com/lullabyreconnect'

function preload() {
  font = loadFont("roboto.ttf");
  wordlist = loadStrings('list.txt');
  audionames = ['em.wav', 'hoi.wav', 'anh.wav', 'bao.wav','gio.wav', 'tro.wav', 'lai.wav', 'dem.wav', 'hao.wav', 'mon.wav', 'no.wav','ngan.wav', 'con.wav', 'chi.wav', 'me.wav', 'chua.wav', 've.wav', 'voi.wav', 'tron.wav', 'ba.wav', 'ong.wav', 'noi.wav', 'mat.wav', 'tang.wav', 'thay.wav', 'mong.wav', 'choo.wav', 'liem.wav', 'mau.wav', 'thuong.wav', 'troi.wav'
];
...
// class credit {
//   constructor(c){
//     this.position = createVector(15000, width);
//     this.credit = c;
//     this.textSize1 = textSize (20);
//     this.textFont1 = textFont(font);
//   }
  
//   showcredit() {
//     fill(260)
//     noStroke()
//     text(this.credit, this.position.x, this.position.y);
//   }
...
class textsounds {
  constructor(t, s) {
    this.pos = createVector(random(20,1950), random(20, 950));
    this.text = t;
